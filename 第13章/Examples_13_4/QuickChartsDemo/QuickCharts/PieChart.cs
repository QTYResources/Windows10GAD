    ...
    public class PieChart : Control
    {
        ...
        private void AddSlices()
        {
            for (int i = _slices.Count; i < _values.Count; i++)
            {
                ...
                _slices.Add(slice);
                slice.ManipulationMode = ManipulationModes.All;
                slice.ManipulationStarted += OnSliceManipulationStarted;
        ...
        protected override void OnApplyTemplate()
        {
            ...
            _sliceCanvas.ManipulationMode = ManipulationModes.All;
            ...
            _legend.ManipulationStarted += OnLegendManipulationStarted;

            UpdateLegend();
        }

        void OnLegendManipulationStarted(object sender, ManipulationStartedRoutedEventArgs e)
        {
            SwitchLegend();
            e.Handled = true;
        }
